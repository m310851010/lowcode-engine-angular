// import {isJSExpression, isObject} from 'lowcode-utils';
function isJSExpression(val: unknown): val is IPublicTypeJSExpression {
  // @ts-ignore
  return val != null && typeof val === 'object' && val['type'] === 'JSExpression' && val['extType'] !== 'function';
}

// @ts-ignore
import AliLowCodeEngineExt from '@alilc/lowcode-engine-ext';
import {IPublicModelPluginContext, IPublicTypeJSExpression} from '@alilc/lowcode-types';
import {project} from '@alilc/lowcode-engine';


export const SetterPlugin = (ctx: IPublicModelPluginContext) => {
